 ...
 *
 * Efeito de luz volumétrica em WebGL (OGL). Usado como fundo decorativo
 * atrás de conteúdo posicionado com `relative`.
 */
...
// Dourado oficial da identidade Arkano Club (ver identidade/design-guide.md)
