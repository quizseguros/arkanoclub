...
export default function EncomendaPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Mobile com imagem: Web Share API envia texto + arquivo direto pro WhatsApp
    if (imageFile && typeof navigator !== "undefined" && navigator.canShare?.({ files: [imageFile] })) {
      try {
        await navigator.share({ files: [imageFile], text: lines });
        return;
      } catch {
